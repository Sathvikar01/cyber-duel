...
MOVE_DATA: Dict[str, dict] = {
    "jab": {
        "damage": 6, "staminaCost": 8, "range": 3.4,
    ...
    "cross": {
        "damage": 10, "staminaCost": 12, "range": 4.0,
    ...
    "low_kick": {
        "damage": 8, "staminaCost": 10, "range": 3.6,
        "startup": 0.14, "active": 0.08, "recovery": 0.32,
        "cancelWindow": 0.28, "hitReaction": "stumble",
        "knockback": 0.35, "attackerPushback": 0.04,
    ...
    "roundhouse": {
        "damage": 14, "staminaCost": 22, "range": 4.4,
    ...
    "uppercut": {
        "damage": 16, "staminaCost": 24, "range": 3.5,
    ...
    "parry": {
        "damage": 0, "staminaCost": 10, "range": 0,
        "startup": 0.05, "active": 0.30, "recovery": 0.25,
        "cancelWindow": 0.0, "hitReaction": "none",
        "knockback": 0, "attackerPushback": 0,
        "hitstop": 0, "blockedHitstop": 0.06,
        "shake": 0, "blockedShake": 0.14,
        "anticipationWeight": 0.10,
        "tags": ("defensive", "counter"),
    },
    "backstep": {
        "damage": 0, "staminaCost": 16, "range": 0,
        "startup": 0.0, "active": 0.28, "recovery": 0.20,
        "cancelWindow": 0.0, "hitReaction": "none",
        "knockback": 0, "attackerPushback": 0,
    ...
    "clinch": {
        "damage": 5, "staminaCost": 18, "range": 2.0,
        "startup": 0.10, "active": 0.16, "recovery": 0.24,
        "cancelWindow": 0.0, "hitReaction": "clinched",
        "knockback": 0, "attackerPushback": 0,
        "hitstop": 0.05, "blockedHitstop": 0.03,
        "shake": 0.18, "blockedShake": 0.10,
        "anticipationWeight": 0.20,
        "tags": ("grapple", "clinch"),
    },
    "throw": {
        "damage": 18, "staminaCost": 26, "range": 2.2,
        "startup": 0.12, "active": 0.16, "recovery": 0.22,
